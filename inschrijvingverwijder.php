...
<html>
    ...
    <body>
        ...
        if (isset($_GET["id"]) && $_GET["id"] != "") {
            $id = $_GET["id"];
        //De query welke de inschrijving uit de database verwijderd
            if (isset($_GET['bevestiging'])) {
                try {
                    $stmt = $con->prepare("DELETE FROM inschrijvenevenement WHERE id=?");
        ...
        //vraagt gebruiker of hij zeker wil dat hij het item wil verwijderen
                ...
                print("<form method=\"get\" action=\"inschrijvingverwijder.php\" >");
